"""Generate guzheng ABC samples from a fine-tuned NotaGen checkpoint.
...
Run:
    python notagen/generate.py --size small --num 5
    python notagen/generate.py --size medium --num 10 --temperature 0.9
"""
import argparse
import subprocess
import sys
...
# Single-voice 4/4 in C, 1/32 unit. Must match training metadata.
PROMPT_LINES = [
    "L:1/32\n",
    "M:4/4\n",
    "K:C\n",
