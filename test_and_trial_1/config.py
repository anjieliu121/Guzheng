"""Configuration for the guzheng transformer experiment."""
...
class ModelConfig:
    ...
    dropout: float = 0.15  # increased from 0.1 for regularization
...
class TrainConfig:
    ...
    early_stopping_patience: int = 30  # new: early stopping
    save_every: int = 20
    log_every: int = 10
    seed: int = 42
